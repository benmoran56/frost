...
class Frame:
    ...
    def _get_widget_position(self):
        ...
        y_offset = sum([widget.height + self._widget_buffer for widget in self._widgets]) + self._widget_buffer
        return self._x + self._border + self._widget_buffer, self._height - self._menusize + self._border - y_offset
